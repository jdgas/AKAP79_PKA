...
PKA_AKAP_Restri <- function(t, state, parameters) {
  ...
  # Force Thermodynamical constraints
  # Unphos. Loop -> change to 87
  # kf_RiixC__Rii_C = (kb_RiixC__Rii_C*kf_cAMPxRii__Rii_cAMP*kf_Rii_cAMPxC__Rii_C_cAMP*kb_Rii_CxcAMP__Rii_C_cAMP)/
  #   (kb_cAMPxRii__Rii_cAMP*kb_Rii_cAMPxC__Rii_C_cAMP*kf_Rii_CxcAMP__Rii_C_cAMP);
  kf_cAMPxRii__Rii_cAMP = (kb_cAMPxRii__Rii_cAMP * kf_RiixC__Rii_C * kf_Rii_CxcAMP__Rii_C_cAMP * kb_Rii_cAMPxC__Rii_C_cAMP) /
    (kb_RiixC__Rii_C * kb_Rii_CxcAMP__Rii_C_cAMP * kf_Rii_cAMPxC__Rii_C_cAMP);
  
  # Phos. Loop change to 43
  # kf_RiiPXcAMP__RiiP_cAMP = (kb_RiiPXcAMP__RiiP_cAMP*kf_RiiPxC__RiiP_C*kf_RiiP_CxcAMP__RiiP_C_cAMP *kb_RiiP_cAMPxC__RiiP_C_cAMP)/
  #   (kb_RiiPxC__RiiP_C*kb_RiiP_CxcAMP__RiiP_C_cAMP*kf_RiiP_cAMPxC__RiiP_C_cAMP);
  kf_RiiPXcAMP__RiiP_cAMP = (kb_RiiPXcAMP__RiiP_cAMP * kf_RiiPxC__RiiP_C * kf_RiiP_CxcAMP__RiiP_C_cAMP * kb_RiiP_cAMPxC__RiiP_C_cAMP) / 
    (kb_RiiPxC__RiiP_C * kb_RiiP_CxcAMP__RiiP_C_cAMP * kf_RiiP_cAMPxC__RiiP_C_cAMP);
  ...
  # # Force Highest & Lowest KD
  # kb_RiixC__Rii_C = (kb_Rii_cAMPxC__Rii_C_cAMP/kf_Rii_cAMPxC__Rii_C_cAMP) * kf_RiixC__Rii_C;
  # kb_RiiPxC__RiiP_C = (kb_RiixC__Rii_C/kf_RiixC__Rii_C) * kf_RiiPxC__RiiP_C;
  # kb_RiiP_cAMPxC__RiiP_C_cAMP = (kb_RiiPxC__RiiP_C/kf_RiiPxC__RiiP_C) * kf_RiiP_cAMPxC__RiiP_C_cAMP;
  # kb_Rii_cAMPxC__Rii_C_cAMP = (kb_RiiP_cAMPxC__RiiP_C_cAMP/kf_RiiP_cAMPxC__RiiP_C_cAMP) * kf_Rii_cAMPxC__Rii_C_cAMP;

  if ( p_AKAP == 1){ # 98A Mutation 
    kf_Rii_C__RiiP_C = 0;
    kf_Rii_C_cAMP__RiiP_C_cAMP = 0;
  }else if ( p_AKAP == 2){ # 98E Mutation 
    kf_RiiP_CaN__RiixCaN = 0;
    kf_RiiP_cAMP_CaN__CaNXRii_cAMP = 0;
  }
  ...
  #reaction_43 = (0*cAMP*RiiP)-(kb_RiiPXcAMP__RiiP_cAMP*RiiP_cAMP)
  ...
  #reaction_78 = (0*cAMP*Rii)-(kb_cAMPxRii__Rii_cAMP*Rii_cAMP)
