...
%Idx 28 and 29 is the Km value  Km_OFF=100 (66 150) Km_ON=1 (0.67 1.5) (Reference Matt and Parul)
...
if const_flag==1
    %t_idx=[14, 24, 10, 15, 13, 11, 16, 12;... %First thermodyn constr
      %      7, 6, 8, 2, 5, 9, 3, 4];          %Second thermodyn constr

      t_idx=[10, 11, 14, 12, 16, 24, 13, 15;
            7, 6, 8, 2, 5, 9, 3, 4];% Kf34
